  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      <div className="absolute inset-0">
        <div className="absolute -top-40 -left-32 h-105 w-105 rounded-full bg-(--cloud-1) opacity-70 blur-[120px] animate-float-slow" />
        <div className="absolute top-24 -right-30 h-90 w-90 rounded-full bg-(--cloud-2) opacity-60 blur-[120px] animate-float-slow" />
        <div className="absolute -bottom-40 left-[20%] h-115 w-115 rounded-full bg-(--cloud-3) opacity-55 blur-[140px] animate-float-slow" />
      </div>

      <div className="relative mx-auto flex min-h-screen w-full max-w-360 flex-col px-6 pb-20 pt-10 sm:px-10 lg:px-16">
        <ProfileNav />
